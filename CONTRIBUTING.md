# Contributing to whatsapp-msg-client

Thank you for your interest in contributing to `whatsapp-msg-client`!
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/placeholder/whatsapp-msg-client.git
